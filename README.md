...
```
npm create cloudflare@latest -- --template=cloudflare/templates/divine-tooth-42b3
```

A live public deployment of this template is available at [https://divine-tooth-42b3.templates.workers.dev](https://divine-tooth-42b3.templates.workers.dev)
